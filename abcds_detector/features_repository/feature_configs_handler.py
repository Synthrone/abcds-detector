...
from abcds_detector.features_repository.long_form_abcd_features import (
    get_long_form_abcd_feature_configs,
)
from abcds_detector.features_repository.shorts_features import get_shorts_feature_configs
